       ...
       <div class="flex items-center gap-5">
           <a href="javascript:void(0)" class="flex items-center gap-2 pt-4 pl-2.5 mb-5 text-shade-white font-inter">
               ...
               <div class="flex flex-wrap items-center gap-0 sm:gap-2">
                   ...
                   <span class="text-shade-gray text-xs font-inter">
                       Dashboard
                   </span>
               </div>
           </a>
               ...
               <div class="space-y-4 h-[300px]">
                   ...
                   <li>
                       <a href="admin_report_dashboard.php"
                           class="sidebar-menu flex items-center p-2 text-shade-white hover:text-shade-blue hover:bg-shade-white rounded-lg  group">
                           <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                               fill="none">
                   ...
                   <li>
                       <a href="admin_price_dashboard.php"
                           class="sidebar-menu flex items-center p-2 text-shade-blue rounded-lg bg-shade-white">
                           <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                               fill="none">
                               <path
                                   ...
                                   stroke="#0047BD" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                               <path d="M15.7495 15.75H18.7495" stroke="#0047BD" stroke-width="1.5"
                                   stroke-linecap="round" stroke-linejoin="round" />
                               <path d="M11.2495 15.75H12.7495" stroke="#0047BD" stroke-width="1.5"
                                   stroke-linecap="round" stroke-linejoin="round" />
                               <path d="M2.24951 9.08008H21.7495" stroke="#0047BD" stroke-width="1.5"
                                   stroke-linecap="round" stroke-linejoin="round" />
                           </svg>
                   ...
                   <li>
                       <a href="archive_report.php"
                           ...
                           <svg xmlns="http://www.w3.org/2000/svg"
                               ...
                               xmlns:xlink="http://www.w3.org/1999/xlink" height="18px" version="1.1"
                               viewBox="0 0 18 18" width="18px">
                               <title />
                               <desc />
                               <defs />
                               <g fill="none" fill-rule="evenodd" id="Page-1" stroke="none" stroke-width="1">
                                   <g fill="#EAEAEA" stroke="#EAEAEA" id="Core"
