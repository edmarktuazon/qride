        ...
        <div class="space-y-5 py-10">
            <div class="flex items-center gap-5">
                ...
                w-full text-shade-blue font-[900] font-roboto text-base">
                    Name
                    <input type="text" id="driver_name" name="driver_name" value="Reynaldo Seranno"
            ...
            <div class="space-y-2">
                ...
                w-full text-shade-blue font-[900] font-roboto text-base">
                        TODA
                        <input type="text" id="toda" name="toda" value="SJMP TODA"
                ...
                w-full text-shade-blue font-[900] font-roboto text-base">
                        PLATE NO.
                        <input type="text" id="plate_number" name="plate_number" value="1760 XT"
                            class="p-0 w-full bg-shade-white border-none text-shade-black text-base font-normal ">
                    </label>
                </div>
            </div>
            ...
            <div class="swiper mySwiper !mb-10">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide w-full h-full rounded-xl !left-[-76px]">
                        <img src="../assets/images/driver-image/reynaldo/trike-image-01.jpg" alt="trike image">
                    </div>
                    <div class="swiper-slide w-full h-full rounded-xl !left-[-76px]">
                        <img src="../assets/images/driver-image/reynaldo/trike-image-02.jpg" alt="trike image">
                    </div>
                    <div class="swiper-slide w-full h-full rounded-xl !left-[-76px]">
                        <img src="../assets/images/driver-image/reynaldo/trike-image-03.jpg" alt="trike image">
                    </div>
                </div>
            </div>
            <a href="../driver-info/confirmation/report_confirmation_for_reynaldo.php">
                <button
