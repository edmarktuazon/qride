    ...
    <section class="custom-layout custom-height">
        <div class="custom-content">
            <div class="flex items-center gap-5">
                <img src="../../assets/images/driver-image/kathron/driver-profile-image.jpg" alt="Driver's Image"
            ...
            <div class="flex flex-col items-center justify-center gap-5">
                <a href="../../driver-info/concern/concern_for_kathron.php" class="w-full">
                    <button
                ...
                <a href="../../driver-info/kathron_info.php" class="w-full">
                    <button
