    ...
    <section class="custom-layout">
        <form method=" post" name="submit_form"
            ...
            <div class="flex items-center gap-5">
                <img src="../../assets/images/driver-image/albert/driver-profile-image.jpg" alt="Driver's Image"
                    class="h-32 object-contain sm:h-48">
                <input type="hidden" name="driver_image_url" id="driver_image_url"
                    value="./assets/images/driver-image/albert/driver-profile-image.jpg">
            ...
            <input type="hidden" id="driver_name" name="driver_name" value="Albert Macabali"
            ...
            <input type="hidden" id="plate_number" name="plate_number" value="436RRB"
                class="p-0 w-full border-none text-shade-black text-sm font-normal ">
            ...
            <label for="complainant_number" class="hidden gap-4 w-full text-shade-blue font-[900] font-roboto text-sm">
            ...
            <div class="grid gap-5 items-end md:flex">
                <button type="button" id="submitAlbertReport"
                ...
                <button type="button" id="submitAlbertReportNonUa"
                    class="bg-shade-yellow text-shade-deep-blue font-roboto text-lg p-4 rounded-2xl w-full hover:text-shade-white hover:bg-shade-blue">
