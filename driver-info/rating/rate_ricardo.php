    ...
    <section class="custom-layout">
        <form method=" post" name="submit_form"
            ...
            <div class="flex items-center gap-5">
                <img src="../../assets/images/driver-image/ricardo/driver-profile-image.jpg" alt="Driver's Image"
                    class="h-32 object-contain sm:h-48">
                <input type="hidden" name="driver_image_url" id="driver_image_url"
                    value="./assets/images/driver-image/ricardo/driver-profile-image.jpg">
                <div class="flex flex-col gap-2">
                    <span class=" text-shade-blue font-[900] font-roboto text-base">
                        Name
                    </span>
                    <h3 class="text-shade-black font-normal text-2xl">
                        Ricardo L. Constantino
                    </h3>
                </div>
            </div>
            <input type="hidden" id="driver_name" name="driver_name" value="Ricardo L. Constantino"
            ...
            <input type="hidden" id="plate_number" name="plate_number" value="844CNU"
                class="p-0 w-full border-none text-shade-black text-sm font-normal ">
            ...
            <div class="flex gap-5 items-end">
                <button type="button" id="submitRicardoReport"
                ...
                <button type="button" id="submitRicardoReportNonUa"
                    class="bg-shade-yellow text-shade-deep-blue font-roboto text-lg p-4 rounded-2xl w-full hover:text-shade-white hover:bg-shade-blue">
