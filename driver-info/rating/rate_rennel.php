    ...
    <section class="custom-layout">
        <form method=" post" name="submit_form"
            ...
            <div class="flex items-center gap-5">
                <img src="../../assets/images/driver-image/rennel/driver-profile-image.jpg" alt="Driver's Image"
                    class="h-32 object-contain sm:h-48">
                <input type="hidden" name="driver_image_url" id="driver_image_url"
                    value="./assets/images/driver-image/rennel/driver-profile-image.jpg">
            ...
            <input type="hidden" id="driver_name" name="driver_name" value="Rennel C. Lugtu"
            ...
            <input type="hidden" id="plate_number" name="plate_number" value="CO-18376"
                class="p-0 w-full border-none text-shade-black text-sm font-normal ">
            ...
            <div class="flex gap-5 items-end">
                <button type="button" id="submitRennelReport"
                ...
                <button type="button" id="submitRennelReportNonUa"
                    class="bg-shade-yellow text-shade-deep-blue font-roboto text-lg p-4 rounded-2xl w-full hover:text-shade-white hover:bg-shade-blue">
