        ...
        <head>
            ...
            <link rel="stylesheet"
                href="https://cdnjs.cloudflare.com/ajax/libs/sweetalert2/11.7.27/sweetalert2.min.css">
            ...
            <section class="custom-layout">
                <form method=" post" name="submit_form"
                    ...
                    <div class="flex items-center gap-5">
                        <img src="../../assets/images/driver-image/kathron/driver-profile-image.jpg"
                            alt="Driver's Image" class="h-32 object-contain sm:h-48">
                        <input type="hidden" name="driver_image_url" id="driver_image_url"
                            value="./assets/images/driver-image/kathron/driver-profile-image.jpg">
                    ...
                    <input type="hidden" id="driver_name" name="driver_name" value="Kathron Garcia"
                        class="p-0 w-full border-none text-shade-black font-normal text-2xl">
                    <input type="hidden" id="toda" name="toda" value="UA MAIN GATE UNISITE SUBDIVISION DEL PILAR CSFP"
                        class="p-0 w-full border-none text-shade-black text-sm font-normal">
                    <input type="hidden" id="plate_number" name="plate_number" value="BD52469"
                        class="p-0 w-full border-none text-shade-black text-sm font-normal ">
                    <textarea name="message" id="message" cols="30" rows="25"
                        class="hidden bg-[#D9D9D9] w-full border-none  rounded-xl text-shade-black text-sm font-normal"></textarea>
                    <div class="rating flex flex-row justify-center items-center gap-5">
                        <input type="radio" id="rating1" name="rating_1" value="1"
                            class="mask mask-star-2 bg-shade-yellow" checked />
                        <input type="radio" id="rating2" name="rating_1" value="2"
                            class="mask mask-star-2 bg-shade-yellow" />
                        <input type="radio" id="rating3" name="rating_1" value="3"
                            class="mask mask-star-2 bg-shade-yellow" />
                        <input type="radio" id="rating4" name="rating_1" value="4"
                            class="mask mask-star-2 bg-shade-yellow" />
                        <input type="radio" id="rating5" name="rating_1" value="5"
                            class="mask mask-star-2 bg-shade-yellow" />
                    </div>
                    <label for="email_address"
                        class="hidden gap-4 w-full text-shade-blue font-[900] font-roboto text-sm">
                    ...
                    <label for="complainant_number"
                        ...
                        <input type="hidden" id="complainant_number" name="complainant_number"
                            class="bg-[#D9D9D9] w-full border-none  rounded-xl text-shade-black text-sm font-normal" />
                    </label>
                    <div class="flex gap-5 items-end">
                        <button type="button" id="submitKathronReport"
                        ...
                        <button type="button" id="submitKathronReportNonUa"
                            class="bg-shade-yellow text-shade-deep-blue font-roboto text-lg p-4 rounded-2xl w-full hover:text-shade-white hover:bg-shade-blue">
