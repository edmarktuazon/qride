<?php
    ...
    $query = "INSERT INTO reports (driver_name, plate_number, complainant_number, rating, reason, email_address, driver_image_url, activity) VALUES ('$driverName', '$plateNumber', '$complainantNumber', '$rating', '$reason', '$emailAddress', '$driverImageUrl', '$activity')";
...
// delete data from the reports table
    ...
    $deleteQuery = "DELETE FROM reports WHERE id = $deleteId";
...
<body>
    <!-- link for sidebar -->
    <?php include('./includes/admin_report_sidebar.php'); ?>
    ...
    <section class="sm:ml-64">
        ...
        <div class="bg-shade-light-gray min-h-screen px-0 py-10 sm:px-8 lg:px-28">
            ...
            <div class="bg-white mt-10 relative overflow-x-auto">
              ...
              echo "<td>
                <form action='archive_report.php' method='post'>
    ...
    function exportToExcel() {
        ...
        a.href = url;
        a.download = "UA-Report-Data.xlsx";
    ...
    function exportToCSV() {
        ...
        const link = document.createElement("a");
        link.setAttribute("href", encodedUri);
        link.setAttribute("download", "UA-Report-Data.csv");
        link.click();
    }
    ...
    const confirmDelete = (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = "admin_report_dashboard.php?delete_id=" + id;
            }
        });
    };
    </script>
